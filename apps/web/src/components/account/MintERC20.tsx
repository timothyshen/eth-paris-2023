...
import { MockERC20__factory, AccountERC6551__factory } from "web3-config";
...
const MintEquipment = () => {
    ...
    const MOCK721Address = useAddress(MockERC20__factory) as string;
    ...
    const handleMint = async () => {
        const data = MockERC20__factory.createInterface().encodeFunctionData(
            "mint",
